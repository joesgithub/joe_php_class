...
<rss version="2.0">
	<channel>
		<title>Joe's PHP Blog</title>
		<link>http://localhost/joe_php_class/blog/</link>
		<description>A blog about nothing</description>
		<image>
			<title>Joe's PHP Blog</title>
			<url>http://localhost/joe_php_class/blog/images/screenshot.png</url>
			<link>http://localhost/joe_php_class/blog/</link>
		</image>
...
//check to make sure at tleast one result came back
...
?>
		...
		<item>
			...
			<link>http://localhost/joe_php_class/blog/index.php?page=single&amp;post_id=<?php echo $row ['post_id']; ?></link>
			<guid>http://localhost/joe_php_class/blog/index.php?page=single&amp;post_id=<?php echo $row ['post_id']; ?></guid>
